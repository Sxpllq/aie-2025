...
def sample(
    ...
    sep: str = typer.Option(",", help="Разделитель в CSV."),
    encoding: str = typer.Option("utf-8", help="Кодировка файла."),
    n_rows: int = typer.Option(5, help="Количество строк в выборке."),
):
    """Вывести N случайных строк из датасета."""
...
def report(
    ...
    min_missing_share: float = typer.Option(0.5, help="Мин. доля пропусков для проблемы."),
    ...
    with md_path.open("w", encoding="utf-8") as f:
        ...
        f.write(f"- Колонок с константными значениями: **{quality_flags['n_constant_columns']}**\n")
        f.write(f"- Колонок с высокой кардинальностью: **{quality_flags['n_high_cardinality']}**\n\n")
